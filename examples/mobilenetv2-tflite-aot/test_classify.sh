...
main() {
  echo "=== Phase 1: Downloading MobileNetV2 TFLite and converting to TOSA MLIR ==="
  bazel run --config=dev //examples/mobilenetv2-tflite-aot:download_and_convert
  ...
  bazel build --config=dev //examples/mobilenetv2-tflite-aot:classify
