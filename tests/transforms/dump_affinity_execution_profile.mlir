...
// CHECK-PRETTY:     Estimated Static Work (Op-Bytes): 0.05 M (95.5%)
// CHECK-PRETTY:     Estimated Static Work (Op-Elems): 0.01 M (95.5%)
...
// CHECK-PRETTY:     Estimated Static Data Size: 0.00 MB
// CHECK-PRETTY:     Estimated Static Elements: 0.00 M
// CHECK-PRETTY:     Estimated Static Work (Op-Bytes): 0.00 M (4.5%)
// CHECK-PRETTY:     Estimated Static Work (Op-Elems): 0.00 M (4.5%)
// CHECK-PRETTY:     Fills:  0
// CHECK-PRETTY:     Copies: 0
// CHECK-PRETTY: ========================================================================
...
// CHECK-JSON:       "static-data-size-bytes": 3072,
// CHECK-JSON:       "has-dynamic-data-size": false,
// CHECK-JSON:       "static-elements-count": 768,
// CHECK-JSON:       "has-dynamic-elements": false,
// CHECK-JSON:       "static-work-bytes": 49152,
// CHECK-JSON:       "static-work-elements": 12288,
...
// CHECK-CSV: "coralnpu",1,1,0,3072,768,49152,12288,0,0
...
func.func @main(
    ...
    %arg2: tensor<4x4xi32>,
    %arg3: tensor<4x4xi32>)
    -> (tensor<16x16xi32>, tensor<4x4xi32>) {
  %matmul = stablehlo.dot %arg0, %arg1 : (tensor<16x16xi32>, tensor<16x16xi32>) -> tensor<16x16xi32>
  %add = stablehlo.add %arg2, %arg3 : tensor<4x4xi32>
  return %matmul, %add : tensor<16x16xi32>, tensor<4x4xi32>
}
