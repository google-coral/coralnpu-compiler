module {
  func.func @"batch_matmul_i32_2_4_8-2_8_4"() {
    %cst = arith.constant dense<[[[560, 588, 616, 644], [1456, 1548, 1640, 1732], [2352, 2508, 2664, 2820], [3248, 3468, 3688, 3908]], [[13232, 13516, 13800, 14084], [16176, 16524, 16872, 17220], [19120, 19532, 19944, 20356], [22064, 22540, 23016, 23492]]]> : tensor<2x4x4xi32>
    ...
    %4 = linalg.batch_matmul ins(%0, %1 : tensor<2x4x8xi32>, tensor<2x8x4xi32>) outs(%3 : tensor<2x4x4xi32>) -> tensor<2x4x4xi32>
