...
module {
  func.func @"generic_add_rank2_i32_4_8-4_8"() {
    ...
    %2 = linalg.generic {indexing_maps = [#map, #map, #map], iterator_types = ["parallel", "parallel"]} ins(%0, %1 : tensor<4x8xi32>, tensor<4x8xi32>) outs(%0 : tensor<4x8xi32>) {
