module {
  func.func @fill_rank4_i32_2_2_3_2() {
    %cst = arith.constant dense<1> : tensor<2x2x3x2xi32>
    ...
    %1 = linalg.fill ins(%c1_i32 : i32) outs(%0 : tensor<2x2x3x2xi32>) -> tensor<2x2x3x2xi32>
