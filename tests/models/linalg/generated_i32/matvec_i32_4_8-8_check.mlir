module {
  func.func @"matvec_i32_4_8-8"() {
    %cst = arith.constant dense<[140, 364, 588, 812]> : tensor<4xi32>
    ...
    %4 = linalg.matvec ins(%0, %1 : tensor<4x8xi32>, tensor<8xi32>) outs(%3 : tensor<4xi32>) -> tensor<4xi32>
