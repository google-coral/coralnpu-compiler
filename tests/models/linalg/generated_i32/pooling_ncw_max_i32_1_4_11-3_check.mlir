module {
  func.func @"pooling_ncw_max_i32_1_4_11-3"() {
    %cst = arith.constant dense<[[[2, 3, 4, 5, 6, 7, 8, 9, 10], [13, 14, 15, 16, 17, 18, 19, 20, 21], [24, 25, 26, 27, 28, 29, 30, 31, 32], [35, 36, 37, 38, 39, 40, 41, 42, 43]]]> : tensor<1x4x9xi32>
    ...
    %3 = linalg.fill ins(%c-2147483648_i32 : i32) outs(%2 : tensor<1x4x9xi32>) -> tensor<1x4x9xi32>
    %4 = linalg.pooling_ncw_max {dilations = dense<1> : vector<1xi64>, strides = dense<1> : vector<1xi64>} ins(%0, %1 : tensor<1x4x11xi32>, tensor<3xi32>) outs(%3 : tensor<1x4x9xi32>) -> tensor<1x4x9xi32>
