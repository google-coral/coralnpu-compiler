...
module {
  func.func @"contract_matmul_i32_4_8-8_4"() {
    ...
    %4 = linalg.contract indexing_maps = [#map, #map1, #map2] ins(%0, %1 : tensor<4x8xi32>, tensor<8x4xi32>) outs(%3 : tensor<4x4xi32>) -> tensor<4x4xi32>
