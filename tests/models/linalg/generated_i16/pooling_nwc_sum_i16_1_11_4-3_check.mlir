module {
  func.func @"pooling_nwc_sum_i16_1_11_4-3"() {
    %cst = arith.constant dense<[[[12, 15, 18, 21], [24, 27, 30, 33], [36, 39, 42, 45], [48, 51, 54, 57], [60, 63, 66, 69], [72, 75, 78, 81], [84, 87, 90, 93], [96, 99, 102, 105], [108, 111, 114, 117]]]> : tensor<1x9x4xi16>
    ...
    %4 = linalg.pooling_nwc_sum {dilations = dense<1> : vector<1xi64>, strides = dense<1> : vector<1xi64>} ins(%0, %1 : tensor<1x11x4xi16>, tensor<3xi16>) outs(%3 : tensor<1x9x4xi16>) -> tensor<1x9x4xi16>
