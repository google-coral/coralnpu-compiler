module {
  func.func @"elementwise_add_i16_4_8-4_8"() {
    ...
    %3 = linalg.elementwise kind=#linalg.elementwise_kind<add> ins(%0, %1 : tensor<4x8xi16>, tensor<4x8xi16>) outs(%2 : tensor<4x8xi16>) -> tensor<4x8xi16>
