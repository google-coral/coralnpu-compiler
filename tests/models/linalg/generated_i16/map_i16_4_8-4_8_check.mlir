module {
  func.func @"map_i16_4_8-4_8"() {
    ...
    %mapped = linalg.map { arith.addi {overflowFlags = #arith.overflow<none>} } ins(%0, %1 : tensor<4x8xi16>, tensor<4x8xi16>) outs(%2 : tensor<4x8xi16>)
    %3 = util.optimization_barrier %cst : tensor<4x8xi16>
    "check.expect_eq"(%mapped, %3) : (tensor<4x8xi16>, tensor<4x8xi16>) -> ()
    return
  }
}
