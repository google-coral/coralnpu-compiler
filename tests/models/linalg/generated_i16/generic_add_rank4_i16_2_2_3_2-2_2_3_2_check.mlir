...
module {
  func.func @"generic_add_rank4_i16_2_2_3_2-2_2_3_2"() {
    ...
    %2 = linalg.generic {indexing_maps = [#map, #map, #map], iterator_types = ["parallel", "parallel", "parallel", "parallel"]} ins(%0, %1 : tensor<2x2x3x2xi16>, tensor<2x2x3x2xi16>) outs(%0 : tensor<2x2x3x2xi16>) {
