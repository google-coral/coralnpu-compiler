module {
  func.func @"pooling_nwc_max_unsigned_i16_1_11_4-3"() {
    ...
    %4 = linalg.pooling_nwc_max_unsigned {dilations = dense<1> : vector<1xi64>, strides = dense<1> : vector<1xi64>} ins(%0, %1 : tensor<1x11x4xi16>, tensor<3xi16>) outs(%3 : tensor<1x9x4xi16>) -> tensor<1x9x4xi16>
