module {
  func.func @"batch_reduce_matmul_i16_2_4_8-2_8_4"() {
    %cst = arith.constant dense<[[13792, 14104, 14416, 14728], [17632, 18072, 18512, 18952], [21472, 22040, 22608, 23176], [25312, 26008, 26704, 27400]]> : tensor<4x4xi16>
    ...
    %4 = linalg.batch_reduce_matmul ins(%0, %1 : tensor<2x4x8xi16>, tensor<2x8x4xi16>) outs(%3 : tensor<4x4xi16>) -> tensor<4x4xi16>
