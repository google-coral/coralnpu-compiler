module {
  func.func @transpose_2d_i16_4_8() {
    ...
    %1 = tensor.empty() : tensor<8x4xi16>
    %transposed = linalg.transpose ins(%0 : tensor<4x8xi16>) outs(%1 : tensor<8x4xi16>) permutation = [1, 0] 
    %2 = util.optimization_barrier %cst : tensor<8x4xi16>
    "check.expect_eq"(%transposed, %2) : (tensor<8x4xi16>, tensor<8x4xi16>) -> ()
    return
  }
}
