module {
  func.func @fill_rank4_i16_2_2_3_2() {
    %cst = arith.constant dense<1> : tensor<2x2x3x2xi16>
    ...
    %1 = linalg.fill ins(%c1_i16 : i16) outs(%0 : tensor<2x2x3x2xi16>) -> tensor<2x2x3x2xi16>
