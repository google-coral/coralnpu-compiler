...
func.func @main(%arg0: tensor<1x6x6x8xf32>, %arg1: tensor<4x4x2x2x1x8xf32>) -> tensor<4x4x2x2x1x8xf32> {
  %0 = linalg.winograd_input_transform fmr(F_2_3)
       ins(%arg0 : tensor<1x6x6x8xf32>)
       outs(%arg1 : tensor<4x4x2x2x1x8xf32>) -> tensor<4x4x2x2x1x8xf32>
  return %0 : tensor<4x4x2x2x1x8xf32>
}
