...
func.func @main(%arg0: tensor<?x?x8x16xi16>) -> tensor<?x?xi16> {
  ...
  %outer1 = tensor.dim %arg0, %c0_idx : tensor<?x?x8x16xi16>
  %outer0 = tensor.dim %arg0, %c1_idx : tensor<?x?x8x16xi16>
  ...
  %0 = linalg.unpack %arg0 outer_dims_perm = [1, 0] inner_dims_pos = [0, 1] inner_tiles = [8, 16] into %empty : tensor<?x?x8x16xi16> -> tensor<?x?xi16>
