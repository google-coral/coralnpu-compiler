func.func @main(%arg0: tensor<?x?x?x?x?xi16>, %arg1: tensor<?x?x?xi16>) -> tensor<?x?x?x?x?xi16> {
  %c0 = arith.constant -32768 : i16
  ...
  %kernel_d = tensor.dim %arg1, %c0_idx : tensor<?x?x?xi16>
  ...
  %0 = linalg.pooling_ndhwc_max
       ...
       ins(%arg0, %arg1 : tensor<?x?x?x?x?xi16>, tensor<?x?x?xi16>)
