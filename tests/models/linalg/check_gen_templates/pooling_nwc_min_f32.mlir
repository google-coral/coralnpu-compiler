func.func @main(%arg0: tensor<?x?x?xf32>, %arg1: tensor<?xf32>) -> tensor<?x?x?xf32> {
  %max_f32 = arith.constant 3.40282347E+38 : f32
  ...
  %empty = tensor.empty(%n, %ow, %c) : tensor<?x?x?xf32>
  %fill = linalg.fill ins(%max_f32 : f32) outs(%empty : tensor<?x?x?xf32>) -> tensor<?x?x?xf32>
