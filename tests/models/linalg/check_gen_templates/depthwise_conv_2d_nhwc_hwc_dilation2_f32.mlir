func.func @main(%arg0: tensor<?x?x?x?xf32>, %arg1: tensor<?x?x?xf32>) -> tensor<?x?x?x?xf32> {
  ...
  %0 = linalg.depthwise_conv_2d_nhwc_hwc {dilations = dense<2> : tensor<2xi64>, strides = dense<1> : tensor<2xi64>} ins(%arg0, %arg1 : tensor<?x?x?x?xf32>, tensor<?x?x?xf32>) outs(%fill : tensor<?x?x?x?xf32>) -> tensor<?x?x?x?xf32>
