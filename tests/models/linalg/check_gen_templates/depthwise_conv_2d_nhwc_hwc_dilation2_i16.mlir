func.func @main(%arg0: tensor<?x?x?x?xi16>, %arg1: tensor<?x?x?xi16>) -> tensor<?x?x?x?xi16> {
  ...
  %0 = linalg.depthwise_conv_2d_nhwc_hwc {dilations = dense<2> : tensor<2xi64>, strides = dense<1> : tensor<2xi64>} ins(%arg0, %arg1 : tensor<?x?x?x?xi16>, tensor<?x?x?xi16>) outs(%fill : tensor<?x?x?x?xi16>) -> tensor<?x?x?x?xi16>
