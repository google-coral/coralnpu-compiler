func.func @main(%arg0: tensor<?x?x?xbf16>, %arg1: tensor<?x?xbf16>) -> tensor<?x?xbf16> {
  %c0 = arith.constant 0.0 : bf16
  %c0_idx = arith.constant 0 : index
  %c1_idx = arith.constant 1 : index
  %batch = tensor.dim %arg0, %c0_idx : tensor<?x?x?xbf16>
  %m = tensor.dim %arg0, %c1_idx : tensor<?x?x?xbf16>
  %empty = tensor.empty(%batch, %m) : tensor<?x?xbf16>
