...
def linalg_op_tests_i32(name = "linalg_op_i32_tests", check_mlir_files = None, generation_targets = None, target_dir = "generated_i32"):
    ...
    op_tests_i32(name = "conv_2d_nhwc_hwcf_stride2_i32", instances = [("(1,6,6,4)(3,3,4,4)", ["manual"]), "(1,8,8,8)(3,3,8,16)"], test = "conv_2d_nhwc_hwcf_stride2_i32.mlir")
    op_tests_i32(name = "conv_2d_nhwc_hwcf_dilation2_i32", instances = [("(1,6,6,4)(3,3,4,4)", ["manual"]), "(1,8,8,8)(3,3,8,16)"], test = "conv_2d_nhwc_hwcf_dilation2_i32.mlir")
    ...
    op_tests_i32(name = "pooling_nchw_sum_i32", instances = ["(1,4,11,11)(3,3)", ("(1,8,120,256)(5,7)", ["manual"])], test = "pooling_nchw_sum_i32.mlir")
    op_tests_i32(name = "pooling_nchw_max_i32", instances = ["(1,4,11,11)(3,3)", ("(1,8,120,256)(5,7)", ["manual"])], test = "pooling_nchw_max_i32.mlir")
