...
def linalg_op_tests_i32(name = "linalg_op_i32_tests"):
    ...
    op_tests_i32(name = "matmul_i32", instances = ["(4,8)(8,4)", "(120,256)(256,300)", ("(300,100)(100,450)", ["manual"])], test = "matmul_i32.mlir")
    op_tests_i32(name = "batch_matmul_i32", instances = ["(2,4,8)(2,8,4)", ("(3,12,25)(3,25,30)", ["manual"])], test = "batch_matmul_i32.mlir")
    ...
    op_tests_i32(name = "contract_matmul_i32", instances = ["(4,8)(8,4)", "(120,256)(256,300)", ("(300,100)(100,450)", ["manual"])], test = "contract_matmul_i32.mlir")
    op_tests_i32(name = "batch_reduce_matmul_i32", instances = ["(2,4,8)(2,8,4)", ("(3,12,25)(3,25,30)", ["manual"])], test = "batch_reduce_matmul_i32.mlir")
    op_tests_i32(name = "batch_mmt4d_i32", instances = ["(2,1,2,4,4)(2,2,2,4,4)", ("(3,2,3,4,2)(3,3,3,2,2)", ["manual"])], test = "batch_mmt4d_i32.mlir")
    ...
    op_tests_i32(name = "conv_1d_i32", instances = ["(11)(3)", "(258)(5)", ("(453)(4)", ["manual"])], test = "conv_1d_i32.mlir")
    ...
    op_tests_i32(name = "conv_2d_i32", instances = ["(11,11)(3,3)", ("(125,256)(5,7)", ["manual"])], test = "conv_2d_i32.mlir")
