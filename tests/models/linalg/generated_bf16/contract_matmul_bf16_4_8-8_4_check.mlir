...
module {
  func.func @"contract_matmul_bf16_4_8-8_4"() {
    ...
    %0 = util.optimization_barrier %cst_2 : tensor<4x8xbf16>
    %1 = util.optimization_barrier %cst_0 : tensor<8x4xbf16>
    %2 = tensor.empty() : tensor<4x4xbf16>
    %3 = linalg.fill ins(%cst_1 : bf16) outs(%2 : tensor<4x4xbf16>) -> tensor<4x4xbf16>
    %4 = linalg.contract indexing_maps = [#map, #map1, #map2] ins(%0, %1 : tensor<4x8xbf16>, tensor<8x4xbf16>) outs(%3 : tensor<4x4xbf16>) -> tensor<4x4xbf16>
    %5 = util.optimization_barrier %cst : tensor<4x4xbf16>
    "check.expect_almost_eq"(%4, %5) {atol = 0.00999999977 : f32, rtol = 0.00999999977 : f32} : (tensor<4x4xbf16>, tensor<4x4xbf16>) -> ()
    return
  }
}
