module {
  func.func @"matvec_bf16_4_8-8"() {
    %cst = arith.constant dense<[1.400000e+02, 3.640000e+02, 5.880000e+02, 8.120000e+02]> : tensor<4xbf16>
    ...
    %4 = linalg.matvec ins(%0, %1 : tensor<4x8xbf16>, tensor<8xbf16>) outs(%3 : tensor<4xbf16>) -> tensor<4xbf16>
