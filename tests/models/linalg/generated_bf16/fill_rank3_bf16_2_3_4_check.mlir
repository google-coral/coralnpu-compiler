module {
  func.func @fill_rank3_bf16_2_3_4() {
    %cst = arith.constant dense<1.000000e+00> : tensor<2x3x4xbf16>
    ...
    %1 = linalg.fill ins(%cst_0 : bf16) outs(%0 : tensor<2x3x4xbf16>) -> tensor<2x3x4xbf16>
