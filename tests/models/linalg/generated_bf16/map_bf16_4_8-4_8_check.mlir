module {
  func.func @"map_bf16_4_8-4_8"() {
    ...
    %mapped = linalg.map { arith.addf } ins(%0, %1 : tensor<4x8xbf16>, tensor<4x8xbf16>) outs(%2 : tensor<4x8xbf16>)
    %3 = util.optimization_barrier %cst : tensor<4x8xbf16>
    "check.expect_almost_eq"(%mapped, %3) {atol = 0.00999999977 : f32, rtol = 0.00999999977 : f32} : (tensor<4x8xbf16>, tensor<4x8xbf16>) -> ()
    return
  }
}
