...
def linalg_op_tests_f32(name = "linalg_op_f32_tests", check_mlir_files = None, generation_targets = None, target_dir = "generated_f32"):
    ...
    op_tests_f32(name = "generic_multi_output_f32", instances = ["(4,8)(4,8)", "(120,256)(120,256)", "(300,450)(300,450)"], test = "generic_multi_output_f32.mlir")
    ...
    op_tests_f32(name = "mmt4d_f32", instances = ["(1,2,4,4)(2,2,4,4)", "(10,12,4,4)(12,12,4,4)", "(24,25,4,4)(25,25,4,4)"], test = "mmt4d_f32.mlir")
    op_tests_f32(name = "conv_2d_nhwc_hwcf_f32", instances = ["(1,6,6,4)(3,3,4,4)", "(1,8,8,8)(3,3,8,16)", "(1,65,67,33)(3,3,33,17)"], test = "conv_2d_nhwc_hwcf_f32.mlir")
    op_tests_f32(name = "conv_2d_nhwc_hwcf_stride2_f32", instances = ["(1,6,6,4)(3,3,4,4)", "(1,8,8,8)(3,3,8,16)", "(1,65,67,33)(3,3,33,17)"], test = "conv_2d_nhwc_hwcf_stride2_f32.mlir")
    op_tests_f32(name = "conv_2d_nhwc_hwcf_dilation2_f32", instances = ["(1,6,6,4)(3,3,4,4)", "(1,8,8,8)(3,3,8,16)", "(1,65,67,33)(3,3,33,17)"], test = "conv_2d_nhwc_hwcf_dilation2_f32.mlir")
    op_tests_f32(name = "depthwise_conv_2d_nhwc_hwc_f32", instances = ["(1,6,6,4)(3,3,4)", "(1,8,8,8)(3,3,8)", "(1,65,67,33)(3,3,33)"], test = "depthwise_conv_2d_nhwc_hwc_f32.mlir")
    op_tests_f32(name = "depthwise_conv_2d_nhwc_hwc_stride2_f32", instances = ["(1,6,6,4)(3,3,4)", "(1,8,8,8)(3,3,8)", "(1,65,67,33)(3,3,33)"], test = "depthwise_conv_2d_nhwc_hwc_stride2_f32.mlir")
    op_tests_f32(name = "depthwise_conv_2d_nhwc_hwc_dilation2_f32", instances = ["(1,6,6,4)(3,3,4)", "(1,8,8,8)(3,3,8)", "(1,65,67,33)(3,3,33)"], test = "depthwise_conv_2d_nhwc_hwc_dilation2_f32.mlir")
    op_tests_f32(name = "depthwise_conv_2d_nchw_chw_f32", instances = ["(1,4,6,6)(4,3,3)", "(1,8,8,8)(8,3,3)", "(1,33,65,67)(33,3,3)"], test = "depthwise_conv_2d_nchw_chw_f32.mlir")
    ...
    op_tests_f32(name = "pack_padding_f32", instances = [("(7,15)", ["manual"]), ("(17,33)", ["manual"]), "(120,250)"], test = "pack_padding_f32.mlir")
    ...
    op_tests_f32(name = "batch_mmt4d_f32", instances = ["(2,1,2,4,4)(2,2,2,4,4)", "(2,6,8,4,4)(2,8,8,4,4)", "(2,16,20,4,4)(2,18,20,4,4)"], test = "batch_mmt4d_f32.mlir")
    ...
    op_tests_f32(name = "conv_1d_f32", instances = ["(11)(3)", "(258)(5)", "(453)(4)", "(135001)(5)"], test = "conv_1d_f32.mlir")
    op_tests_f32(name = "conv_1d_nwc_wcf_f32", instances = ["(1,11,4)(3,4,8)", "(1,256,8)(5,8,16)", "(1,4097,33)(5,33,17)"], test = "conv_1d_nwc_wcf_f32.mlir")
    op_tests_f32(name = "conv_1d_ncw_fcw_f32", instances = ["(1,4,11)(8,4,3)", "(1,8,256)(16,8,5)", "(1,33,4097)(17,33,5)"], test = "conv_1d_ncw_fcw_f32.mlir")
    op_tests_f32(name = "conv_2d_f32", instances = ["(11,11)(3,3)", "(125,256)(5,7)", "(301,451)(5,7)"], test = "conv_2d_f32.mlir")
    op_tests_f32(name = "conv_3d_f32", instances = ["(7,7,7)(3,3,3)", "(12,15,20)(2,3,4)", "(33,65,67)(3,3,3)"], test = "conv_3d_f32.mlir")
    op_tests_f32(name = "conv_3d_ndhwc_dhwcf_f32", instances = ["(1,4,4,4,2)(2,2,2,2,4)", "(1,6,6,6,2)(3,3,3,2,4)", "(1,17,33,35,9)(2,3,3,9,7)"], test = "conv_3d_ndhwc_dhwcf_f32.mlir")
    op_tests_f32(name = "conv_3d_ncdhw_fcdhw_f32", instances = ["(1,2,4,4,4)(4,2,2,2,2)", "(1,2,6,6,6)(4,2,3,3,3)", "(1,9,17,33,35)(7,9,2,3,3)"], test = "conv_3d_ncdhw_fcdhw_f32.mlir")
    op_tests_f32(name = "pooling_nhwc_sum_f32", instances = ["(1,11,11,4)(3,3)", "(1,120,256,8)(5,7)", "(1,65,67,33)(3,3)"], test = "pooling_nhwc_sum_f32.mlir")
    op_tests_f32(name = "pooling_nhwc_sum_stride2_f32", instances = ["(1,11,11,4)(3,3)", "(1,120,256,8)(5,7)", "(1,65,67,33)(3,3)"], test = "pooling_nhwc_sum_stride2_f32.mlir")
    op_tests_f32(name = "pooling_nhwc_sum_dilation2_f32", instances = ["(1,11,11,4)(3,3)", "(1,120,256,8)(5,7)", "(1,65,67,33)(3,3)"], test = "pooling_nhwc_sum_dilation2_f32.mlir")
    op_tests_f32(name = "pooling_nhwc_max_f32", instances = ["(1,11,11,4)(3,3)", "(1,120,256,8)(5,7)", "(1,65,67,33)(3,3)"], test = "pooling_nhwc_max_f32.mlir")
    op_tests_f32(name = "pooling_nhwc_max_stride2_f32", instances = ["(1,11,11,4)(3,3)", "(1,120,256,8)(5,7)", "(1,65,67,33)(3,3)"], test = "pooling_nhwc_max_stride2_f32.mlir")
    op_tests_f32(name = "pooling_nhwc_max_dilation2_f32", instances = ["(1,11,11,4)(3,3)", "(1,120,256,8)(5,7)", "(1,65,67,33)(3,3)"], test = "pooling_nhwc_max_dilation2_f32.mlir")
    op_tests_f32(name = "pooling_nhwc_min_f32", instances = ["(1,11,11,4)(3,3)", "(1,120,256,8)(5,7)", "(1,65,67,33)(3,3)"], test = "pooling_nhwc_min_f32.mlir")
    op_tests_f32(name = "depthwise_conv_1d_nwc_wc_f32", instances = ["(1,11,4)(3,4)", "(1,256,8)(5,8)", "(1,4097,33)(5,33)"], test = "depthwise_conv_1d_nwc_wc_f32.mlir")
    op_tests_f32(name = "depthwise_conv_1d_ncw_cw_f32", instances = ["(1,4,11)(4,3)", "(1,8,256)(8,5)", "(1,33,4097)(33,5)"], test = "depthwise_conv_1d_ncw_cw_f32.mlir")
    op_tests_f32(name = "depthwise_conv_1d_nwc_wcm_f32", instances = ["(1,11,4)(3,4,2)", "(1,256,8)(5,8,1)", "(1,4097,33)(5,33,3)"], test = "depthwise_conv_1d_nwc_wcm_f32.mlir")
    op_tests_f32(name = "depthwise_conv_2d_nhwc_hwcm_f32", instances = ["(1,11,11,4)(3,3,4,2)", "(1,120,256,8)(5,5,8,1)", "(1,65,67,33)(3,3,33,3)"], test = "depthwise_conv_2d_nhwc_hwcm_f32.mlir")
    op_tests_f32(name = "depthwise_conv_3d_ndhwc_dhwc_f32", instances = ["(1,7,7,7,4)(3,3,3,4)", "(1,12,15,20,8)(2,3,4,8)", "(1,17,33,35,9)(2,3,3,9)"], test = "depthwise_conv_3d_ndhwc_dhwc_f32.mlir")
    op_tests_f32(name = "depthwise_conv_3d_ndhwc_dhwcm_f32", instances = ["(1,7,7,7,4)(3,3,3,4,2)", "(1,12,15,20,8)(2,3,4,8,1)", "(1,17,33,35,9)(2,3,3,9,3)"], test = "depthwise_conv_3d_ndhwc_dhwcm_f32.mlir")
    op_tests_f32(name = "depthwise_conv_3d_ncdhw_cdhw_f32", instances = ["(1,4,7,7,7)(4,3,3,3)", "(1,8,12,15,20)(8,2,3,4)", "(1,9,17,33,35)(9,2,3,3)"], test = "depthwise_conv_3d_ncdhw_cdhw_f32.mlir")
    op_tests_f32(name = "conv_2d_nchw_fchw_f32", instances = ["(1,4,6,6)(4,4,3,3)", "(1,8,8,8)(16,8,3,3)", "(1,33,65,67)(17,33,3,3)"], test = "conv_2d_nchw_fchw_f32.mlir")
    op_tests_f32(name = "conv_2d_nhwc_fhwc_f32", instances = ["(1,6,6,4)(4,3,3,4)", "(1,8,8,8)(16,3,3,8)", "(1,65,67,33)(17,3,3,33)"], test = "conv_2d_nhwc_fhwc_f32.mlir")
    op_tests_f32(name = "conv_2d_nhwgc_gfhwc_f32", instances = ["(1,6,6,2,2)(2,4,3,3,2)", "(1,8,8,4,2)(4,8,3,3,2)", "(1,65,67,3,11)(3,7,3,3,11)"], test = "conv_2d_nhwgc_gfhwc_f32.mlir")
    op_tests_f32(name = "conv_2d_ngchw_gfchw_f32", instances = ["(1,2,2,6,6)(2,4,2,3,3)", "(1,4,2,8,8)(4,8,2,3,3)", "(1,3,11,65,67)(3,7,11,3,3)"], test = "conv_2d_ngchw_gfchw_f32.mlir")
    op_tests_f32(name = "conv_2d_ngchw_fgchw_f32", instances = ["(1,2,2,6,6)(4,2,2,3,3)", "(1,4,2,8,8)(8,4,2,3,3)", "(1,3,11,65,67)(7,3,11,3,3)"], test = "conv_2d_ngchw_fgchw_f32.mlir")
    op_tests_f32(name = "pooling_nchw_sum_f32", instances = ["(1,4,11,11)(3,3)", "(1,8,120,256)(5,7)", "(1,33,65,67)(3,3)"], test = "pooling_nchw_sum_f32.mlir")
    op_tests_f32(name = "pooling_nchw_max_f32", instances = ["(1,4,11,11)(3,3)", "(1,8,120,256)(5,7)", "(1,33,65,67)(3,3)"], test = "pooling_nchw_max_f32.mlir")
    op_tests_f32(name = "pooling_nwc_sum_f32", instances = ["(1,11,4)(3)", "(1,120,8)(5)", "(1,4097,33)(5)"], test = "pooling_nwc_sum_f32.mlir")
    op_tests_f32(name = "pooling_nwc_max_f32", instances = ["(1,11,4)(3)", "(1,120,8)(5)", "(1,4097,33)(5)"], test = "pooling_nwc_max_f32.mlir")
    op_tests_f32(name = "pooling_nwc_min_f32", instances = ["(1,11,4)(3)", "(1,120,8)(5)", "(1,4097,33)(5)"], test = "pooling_nwc_min_f32.mlir")
    op_tests_f32(name = "pooling_ncw_sum_f32", instances = ["(1,4,11)(3)", "(1,8,120)(5)", "(1,33,4097)(5)"], test = "pooling_ncw_sum_f32.mlir")
    op_tests_f32(name = "pooling_ncw_max_f32", instances = ["(1,4,11)(3)", "(1,8,120)(5)", "(1,33,4097)(5)"], test = "pooling_ncw_max_f32.mlir")
    op_tests_f32(name = "pooling_ndhwc_sum_f32", instances = ["(1,7,7,7,4)(3,3,3)", "(1,12,15,20,8)(2,3,4)", "(1,17,33,35,9)(2,3,3)"], test = "pooling_ndhwc_sum_f32.mlir")
    op_tests_f32(name = "pooling_ndhwc_max_f32", instances = ["(1,7,7,7,4)(3,3,3)", "(1,12,15,20,8)(2,3,4)", "(1,17,33,35,9)(2,3,3)"], test = "pooling_ndhwc_max_f32.mlir")
    op_tests_f32(name = "pooling_ndhwc_min_f32", instances = ["(1,7,7,7,4)(3,3,3)", "(1,12,15,20,8)(2,3,4)", "(1,17,33,35,9)(2,3,3)"], test = "pooling_ndhwc_min_f32.mlir")
