...
def linalg_op_tests_f32(name = "linalg_op_f32_tests"):
    ...
    op_tests_f32(name = "batch_mmt4d_f32", instances = ["(2,1,2,4,4)(2,2,2,4,4)", ("(3,2,3,4,2)(3,3,3,2,2)", ["manual"])], test = "batch_mmt4d_f32.mlir")
    ...
    op_tests_f32(name = "conv_1d_f32", instances = ["(11)(3)", "(258)(5)", ("(453)(4)", ["manual"])], test = "conv_1d_f32.mlir")
    ...
    op_tests_f32(name = "conv_2d_f32", instances = ["(11,11)(3,3)", ("(125,256)(5,7)", ["manual"])], test = "conv_2d_f32.mlir")
