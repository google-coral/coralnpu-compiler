...
def linalg_op_tests_f32(name = "linalg_op_f32_tests", check_mlir_files = None, generation_targets = None, target_dir = "generated_f32"):
    ...
    op_tests_f32(name = "conv_2d_nhwc_hwcf_stride2_f32", instances = [("(1,6,6,4)(3,3,4,4)", ["manual"]), "(1,8,8,8)(3,3,8,16)"], test = "conv_2d_nhwc_hwcf_stride2_f32.mlir")
    op_tests_f32(name = "conv_2d_nhwc_hwcf_dilation2_f32", instances = [("(1,6,6,4)(3,3,4,4)", ["manual"]), "(1,8,8,8)(3,3,8,16)"], test = "conv_2d_nhwc_hwcf_dilation2_f32.mlir")
    ...
    op_tests_f32(name = "pack_padding_f32", instances = ["(7,15)", "(17,33)", "(120,250)"], test = "pack_padding_f32.mlir", tags = ["manual"])
    ...
    op_tests_f32(name = "pooling_nchw_sum_f32", instances = ["(1,4,11,11)(3,3)", ("(1,8,120,256)(5,7)", ["manual"])], test = "pooling_nchw_sum_f32.mlir")
    op_tests_f32(name = "pooling_nchw_max_f32", instances = ["(1,4,11,11)(3,3)", ("(1,8,120,256)(5,7)", ["manual"])], test = "pooling_nchw_max_f32.mlir")
