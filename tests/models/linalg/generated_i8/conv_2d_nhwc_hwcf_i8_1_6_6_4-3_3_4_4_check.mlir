module {
  func.func @"conv_2d_nhwc_hwcf_i8_1_6_6_4-3_3_4_4"() {
    %cst = arith.constant dense<[[[[24, 62, 100, -118], [120, 46, -28, -102], [-40, 30, 100, -86], [56, 14, -28, -70]], [[88, -34, 100, -22], [-72, -50, -28, -6], [24, -66, 100, 10], [120, -82, -28, 26]], [[-104, 126, 100, 74], [-8, 110, -28, 90], [88, 94, 100, 106], [-72, 78, -28, 122]], [[-40, 30, 100, -86], [56, 14, -28, -70], [-104, -2, 100, -54], [-8, -18, -28, -38]]]]> : tensor<1x4x4x4xi8>
    ...
    %4 = linalg.conv_2d_nhwc_hwcf {dilations = dense<1> : tensor<2xi64>, strides = dense<1> : tensor<2xi64>} ins(%0, %1 : tensor<1x6x6x4xi8>, tensor<3x3x4x4xi8>) outs(%3 : tensor<1x4x4x4xi8>) -> tensor<1x4x4x4xi8>
