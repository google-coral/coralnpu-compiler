module {
  func.func @"vecmat_i8_8-8_4"() {
    %cst = arith.constant dense<[48, 76, 104, -124]> : tensor<4xi8>
    ...
    %3 = linalg.fill ins(%c0_i8 : i8) outs(%2 : tensor<4xi8>) -> tensor<4xi8>
    %4 = linalg.vecmat ins(%0, %1 : tensor<8xi8>, tensor<8x4xi8>) outs(%3 : tensor<4xi8>) -> tensor<4xi8>
    %5 = util.optimization_barrier %cst : tensor<4xi8>
    "check.expect_eq"(%4, %5) : (tensor<4xi8>, tensor<4xi8>) -> ()
    return
  }
}
