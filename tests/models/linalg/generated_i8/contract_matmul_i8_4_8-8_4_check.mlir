...
module {
  func.func @"contract_matmul_i8_4_8-8_4"() {
    ...
    %4 = linalg.contract indexing_maps = [#map, #map1, #map2] ins(%0, %1 : tensor<4x8xi8>, tensor<8x4xi8>) outs(%3 : tensor<4x4xi8>) -> tensor<4x4xi8>
