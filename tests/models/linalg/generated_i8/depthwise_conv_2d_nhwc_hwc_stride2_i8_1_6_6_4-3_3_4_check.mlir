module {
  func.func @"depthwise_conv_2d_nhwc_hwc_stride2_i8_1_6_6_4-3_3_4"() {
    %cst = arith.constant dense<[[[[-32, 117, 28, -43], [96, 61, 44, 45]], [[-32, 37, 124, -27], [96, -19, -116, 61]]]]> : tensor<1x2x2x4xi8>
    ...
    %4 = linalg.depthwise_conv_2d_nhwc_hwc {dilations = dense<1> : tensor<2xi64>, strides = dense<2> : tensor<2xi64>} ins(%0, %1 : tensor<1x6x6x4xi8>, tensor<3x3x4xi8>) outs(%3 : tensor<1x2x2x4xi8>) -> tensor<1x2x2x4xi8>
