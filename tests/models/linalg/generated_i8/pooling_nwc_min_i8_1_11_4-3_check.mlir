module {
  func.func @"pooling_nwc_min_i8_1_11_4-3"() {
    ...
    %3 = linalg.fill ins(%c127_i8 : i8) outs(%2 : tensor<1x9x4xi8>) -> tensor<1x9x4xi8>
    %4 = linalg.pooling_nwc_min {dilations = dense<1> : vector<1xi64>, strides = dense<1> : vector<1xi64>} ins(%0, %1 : tensor<1x11x4xi8>, tensor<3xi8>) outs(%3 : tensor<1x9x4xi8>) -> tensor<1x9x4xi8>
