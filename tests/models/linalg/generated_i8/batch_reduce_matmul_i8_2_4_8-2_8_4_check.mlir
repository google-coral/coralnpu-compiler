module {
  func.func @"batch_reduce_matmul_i8_2_4_8-2_8_4"() {
    %cst = arith.constant dense<[[-32, 24, 80, -120], [-32, -104, 80, 8], [-32, 24, 80, -120], [-32, -104, 80, 8]]> : tensor<4x4xi8>
    ...
    %4 = linalg.batch_reduce_matmul ins(%0, %1 : tensor<2x4x8xi8>, tensor<2x8x4xi8>) outs(%3 : tensor<4x4xi8>) -> tensor<4x4xi8>
