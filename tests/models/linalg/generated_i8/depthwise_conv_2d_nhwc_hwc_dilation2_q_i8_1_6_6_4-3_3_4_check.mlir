module {
  func.func @"depthwise_conv_2d_nhwc_hwc_dilation2_q_i8_1_6_6_4-3_3_4"() {
    %cst = arith.constant dense<[[[[11964, 12558, 13170, 13800], [12720, 13350, 13998, 14664]], [[-1420, -1122, -806, -472], [-664, -330, 22, 392]]]]> : tensor<1x2x2x4xi32>
    ...
    %4 = linalg.depthwise_conv_2d_nhwc_hwc_q {dilations = dense<2> : tensor<2xi64>, strides = dense<1> : tensor<2xi64>} ins(%0, %1, %c12_i32, %c-5_i32 : tensor<1x6x6x4xi8>, tensor<3x3x4xi8>, i32, i32) outs(%3 : tensor<1x2x2x4xi32>) -> tensor<1x2x2x4xi32>
