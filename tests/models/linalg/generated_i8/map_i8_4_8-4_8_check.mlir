module {
  func.func @"map_i8_4_8-4_8"() {
    ...
    %mapped = linalg.map { arith.addi {overflowFlags = #arith.overflow<none>} } ins(%0, %1 : tensor<4x8xi8>, tensor<4x8xi8>) outs(%2 : tensor<4x8xi8>)
    %3 = util.optimization_barrier %cst : tensor<4x8xi8>
    "check.expect_eq"(%mapped, %3) : (tensor<4x8xi8>, tensor<4x8xi8>) -> ()
    return
  }
}
