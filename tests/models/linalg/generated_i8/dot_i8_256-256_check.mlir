module {
  func.func @"dot_i8_256-256"() {
    %cst = arith.constant dense<-128> : tensor<i8>
    ...
    %0 = util.optimization_barrier %cst_0 : tensor<256xi8>
    %1 = util.optimization_barrier %cst_0 : tensor<256xi8>
    %2 = tensor.empty() : tensor<i8>
    %3 = linalg.fill ins(%c0_i8 : i8) outs(%2 : tensor<i8>) -> tensor<i8>
    %4 = linalg.dot ins(%0, %1 : tensor<256xi8>, tensor<256xi8>) outs(%3 : tensor<i8>) -> tensor<i8>
