module {
  func.func @"matvec_i8_4_8-8"() {
    %cst = arith.constant dense<[-116, 108, 76, 44]> : tensor<4xi8>
    ...
    %4 = linalg.matvec ins(%0, %1 : tensor<4x8xi8>, tensor<8xi8>) outs(%3 : tensor<4xi8>) -> tensor<4xi8>
