...
def linalg_op_tests_bf16(name = "linalg_op_bf16_tests", check_mlir_files = None, generation_targets = None, target_dir = "generated_bf16"):
    ...
    op_tests_bf16(name = "conv_3d_bf16", instances = ["(7,7,7)(3,3,3)", "(12,15,20)(2,3,4)", "(33,65,67)(3,3,3)"], test = "conv_3d_bf16.mlir", timeout = "moderate")
    op_tests_bf16(name = "conv_3d_ndhwc_dhwcf_bf16", instances = ["(1,4,4,4,2)(2,2,2,2,4)", "(1,6,6,6,2)(3,3,3,2,4)", "(1,17,33,35,9)(2,3,3,9,7)"], test = "conv_3d_ndhwc_dhwcf_bf16.mlir", timeout = "moderate")
    op_tests_bf16(name = "conv_3d_ncdhw_fcdhw_bf16", instances = ["(1,2,4,4,4)(4,2,2,2,2)", "(1,2,6,6,6)(4,2,3,3,3)", "(1,9,17,33,35)(7,9,2,3,3)"], test = "conv_3d_ncdhw_fcdhw_bf16.mlir", timeout = "moderate")
    ...
    op_tests_bf16(name = "depthwise_conv_3d_ndhwc_dhwc_bf16", instances = ["(1,7,7,7,4)(3,3,3,4)", "(1,12,15,20,8)(2,3,4,8)", "(1,17,33,35,9)(2,3,3,9)"], test = "depthwise_conv_3d_ndhwc_dhwc_bf16.mlir", timeout = "moderate")
    op_tests_bf16(name = "depthwise_conv_3d_ndhwc_dhwcm_bf16", instances = ["(1,7,7,7,4)(3,3,3,4,2)", "(1,12,15,20,8)(2,3,4,8,1)", "(1,17,33,35,9)(2,3,3,9,3)"], test = "depthwise_conv_3d_ndhwc_dhwcm_bf16.mlir", timeout = "moderate")
    op_tests_bf16(name = "depthwise_conv_3d_ncdhw_cdhw_bf16", instances = ["(1,4,7,7,7)(4,3,3,3)", "(1,8,12,15,20)(8,2,3,4)", "(1,9,17,33,35)(9,2,3,3)"], test = "depthwise_conv_3d_ncdhw_cdhw_bf16.mlir", timeout = "moderate")
    op_tests_bf16(name = "conv_2d_nchw_fchw_bf16", instances = ["(1,4,6,6)(4,4,3,3)", "(1,8,8,8)(16,8,3,3)", "(1,33,65,67)(17,33,3,3)"], test = "conv_2d_nchw_fchw_bf16.mlir", timeout = "moderate")
    op_tests_bf16(name = "conv_2d_nhwc_fhwc_bf16", instances = ["(1,6,6,4)(4,3,3,4)", "(1,8,8,8)(16,3,3,8)", "(1,65,67,33)(17,3,3,33)"], test = "conv_2d_nhwc_fhwc_bf16.mlir", timeout = "moderate")
