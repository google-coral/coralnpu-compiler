...
module {
  func.func @"generic_multi_output_f32_4_8-4_8"() {
    %cst = arith.constant dense<0.000000e+00> : tensor<4x8xf32>
    ...
    %1 = util.optimization_barrier %cst_1 : tensor<4x8xf32>
    %2 = tensor.empty() : tensor<4x8xf32>
    %3:2 = linalg.generic {indexing_maps = [#map, #map, #map, #map], iterator_types = ["parallel", "parallel"]} ins(%0, %1 : tensor<4x8xf32>, tensor<4x8xf32>) outs(%2, %2 : tensor<4x8xf32>, tensor<4x8xf32>) {
    ^bb0(%in: f32, %in_2: f32, %out: f32, %out_3: f32):
      %6 = arith.addf %in, %in_2 : f32
      %7 = arith.subf %in, %in_2 : f32
      linalg.yield %6, %7 : f32, f32
    } -> (tensor<4x8xf32>, tensor<4x8xf32>)
    %4 = util.optimization_barrier %cst_0 : tensor<4x8xf32>
    "check.expect_almost_eq"(%3#0, %4) {rtol = 9.99999997E-7 : f32} : (tensor<4x8xf32>, tensor<4x8xf32>) -> ()
    %5 = util.optimization_barrier %cst : tensor<4x8xf32>
    "check.expect_almost_eq"(%3#1, %5) {rtol = 9.99999997E-7 : f32} : (tensor<4x8xf32>, tensor<4x8xf32>) -> ()
    return
  }
}
