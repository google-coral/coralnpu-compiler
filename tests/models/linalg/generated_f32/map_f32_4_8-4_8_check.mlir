module {
  func.func @"map_f32_4_8-4_8"() {
    ...
    %mapped = linalg.map { arith.addf } ins(%0, %1 : tensor<4x8xf32>, tensor<4x8xf32>) outs(%2 : tensor<4x8xf32>)
    %3 = util.optimization_barrier %cst : tensor<4x8xf32>
    "check.expect_almost_eq"(%mapped, %3) {rtol = 9.99999997E-7 : f32} : (tensor<4x8xf32>, tensor<4x8xf32>) -> ()
    return
  }
}
