module {
  func.func @fill_rank3_f32_2_3_4() {
    %cst = arith.constant dense<1.000000e+00> : tensor<2x3x4xf32>
    ...
    %1 = linalg.fill ins(%cst_0 : f32) outs(%0 : tensor<2x3x4xf32>) -> tensor<2x3x4xf32>
