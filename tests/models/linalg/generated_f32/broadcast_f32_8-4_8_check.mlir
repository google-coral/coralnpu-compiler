module {
  func.func @"broadcast_f32_8-4_8"() {
    ...
    %broadcasted = linalg.broadcast ins(%0 : tensor<8xf32>) outs(%2 : tensor<4x8xf32>) dimensions = [0] 
    %3 = util.optimization_barrier %cst : tensor<4x8xf32>
    "check.expect_almost_eq"(%broadcasted, %3) {rtol = 9.99999997E-7 : f32} : (tensor<4x8xf32>, tensor<4x8xf32>) -> ()
    return
  }
}
