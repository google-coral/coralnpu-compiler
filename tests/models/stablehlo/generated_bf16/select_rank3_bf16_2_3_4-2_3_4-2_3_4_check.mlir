module {
  func.func @"select_rank3_bf16_2_3_4-2_3_4-2_3_4"() {
    ...
    %3 = stablehlo.select %0, %1, %2 : tensor<2x3x4xi1>, tensor<2x3x4xbf16>
    %4 = util.optimization_barrier %cst : tensor<2x3x4xbf16>
    "check.expect_almost_eq"(%3, %4) {atol = 0.00999999977 : f32, rtol = 0.00999999977 : f32} : (tensor<2x3x4xbf16>, tensor<2x3x4xbf16>) -> ()
    return
  }
}
