module {
  func.func @"matmul_rank1_bf16_8-8"() {
    ...
    %2 = stablehlo.dot %0, %1 : (tensor<8xbf16>, tensor<8xbf16>) -> tensor<bf16>
    %3 = util.optimization_barrier %cst : tensor<bf16>
    "check.expect_almost_eq"(%2, %3) {atol = 0.00999999977 : f32, rtol = 0.00999999977 : f32} : (tensor<bf16>, tensor<bf16>) -> ()
    return
  }
}
