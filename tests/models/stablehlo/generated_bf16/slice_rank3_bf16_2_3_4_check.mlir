module {
  func.func @slice_rank3_bf16_2_3_4() {
    %cst = arith.constant dense<[[[1.700000e+01, 1.800000e+01, 1.900000e+01], [2.100000e+01, 2.200000e+01, 2.300000e+01]]]> : tensor<1x2x3xbf16>
    ...
    %1 = stablehlo.slice %0 [1:2, 1:3, 1:4] : (tensor<2x3x4xbf16>) -> tensor<1x2x3xbf16>
    %2 = util.optimization_barrier %cst : tensor<1x2x3xbf16>
    "check.expect_almost_eq"(%1, %2) {atol = 0.00999999977 : f32, rtol = 0.00999999977 : f32} : (tensor<1x2x3xbf16>, tensor<1x2x3xbf16>) -> ()
    return
  }
}
