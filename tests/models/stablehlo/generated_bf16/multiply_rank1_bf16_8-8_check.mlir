module {
  func.func @"multiply_rank1_bf16_8-8"() {
    %cst = arith.constant dense<[0.000000e+00, 1.000000e+00, 4.000000e+00, 9.000000e+00, 1.600000e+01, 2.500000e+01, 3.600000e+01, 4.900000e+01]> : tensor<8xbf16>
    ...
    %2 = stablehlo.multiply %0, %1 : tensor<8xbf16>
