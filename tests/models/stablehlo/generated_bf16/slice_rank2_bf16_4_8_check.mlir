module {
  func.func @slice_rank2_bf16_4_8() {
    %cst = arith.constant dense<[[1.000000e+01, 1.100000e+01, 1.200000e+01, 1.300000e+01], [1.800000e+01, 1.900000e+01, 2.000000e+01, 2.100000e+01]]> : tensor<2x4xbf16>
    ...
    %1 = stablehlo.slice %0 [1:3, 2:6] : (tensor<4x8xbf16>) -> tensor<2x4xbf16>
    %2 = util.optimization_barrier %cst : tensor<2x4xbf16>
    "check.expect_almost_eq"(%1, %2) {atol = 0.00999999977 : f32, rtol = 0.00999999977 : f32} : (tensor<2x4xbf16>, tensor<2x4xbf16>) -> ()
    return
  }
}
