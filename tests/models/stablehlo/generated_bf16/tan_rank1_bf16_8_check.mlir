module {
  func.func @tan_rank1_bf16_8() {
    %cst = arith.constant dense<[0.000000e+00, 1.554690e+00, -2.187500e+00, -1.425780e-01, 1.156250e+00, -3.375000e+00, -2.910160e-01, 8.710930e-01]> : tensor<8xbf16>
    ...
    %1 = stablehlo.tan %0 : tensor<8xbf16>
