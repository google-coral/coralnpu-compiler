module {
  func.func @is_finite_rank2_bf16_4_8() {
    ...
    %1 = stablehlo.is_finite %0 : (tensor<4x8xbf16>) -> tensor<4x8xi1>
    %2 = util.optimization_barrier %cst : tensor<4x8xi1>
    "check.expect_eq"(%1, %2) : (tensor<4x8xi1>, tensor<4x8xi1>) -> ()
    return
  }
}
