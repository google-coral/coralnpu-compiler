module {
  func.func @reduce_sum_rank3_bf16_2_3_4() {
    %cst = arith.constant dense<[[6.000000e+00, 2.200000e+01, 3.800000e+01], [5.400000e+01, 7.000000e+01, 8.600000e+01]]> : tensor<2x3xbf16>
    ...
    %1 = stablehlo.reduce(%0 init: %cst_0) applies stablehlo.add across dimensions = [2] : (tensor<2x3x4xbf16>, tensor<bf16>) -> tensor<2x3xbf16>
    %2 = util.optimization_barrier %cst : tensor<2x3xbf16>
    "check.expect_almost_eq"(%1, %2) {atol = 0.00999999977 : f32, rtol = 0.00999999977 : f32} : (tensor<2x3xbf16>, tensor<2x3xbf16>) -> ()
    return
  }
}
