module {
  func.func @cosine_rank1_bf16_8() {
    %cst = arith.constant dense<[1.000000e+00, 5.390630e-01, -4.160160e-01, -9.882810e-01, -6.523440e-01, 2.832030e-01, 9.609370e-01, 7.539060e-01]> : tensor<8xbf16>
    ...
    %1 = stablehlo.cosine %0 : tensor<8xbf16>
