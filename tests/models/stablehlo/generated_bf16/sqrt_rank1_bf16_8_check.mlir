module {
  func.func @sqrt_rank1_bf16_8() {
    %cst = arith.constant dense<[0.000000e+00, 1.000000e+00, 1.414060e+00, 1.734380e+00, 2.000000e+00, 2.234380e+00, 2.453130e+00, 2.640630e+00]> : tensor<8xbf16>
    ...
    %1 = stablehlo.sqrt %0 : tensor<8xbf16>
