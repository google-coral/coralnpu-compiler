module {
  func.func @reduce_sum_rank2_bf16_4_8() {
    ...
    %1 = stablehlo.reduce(%0 init: %cst_0) applies stablehlo.add across dimensions = [1] : (tensor<4x8xbf16>, tensor<bf16>) -> tensor<4xbf16>
    %2 = util.optimization_barrier %cst : tensor<4xbf16>
    "check.expect_almost_eq"(%1, %2) {atol = 0.00999999977 : f32, rtol = 0.00999999977 : f32} : (tensor<4xbf16>, tensor<4xbf16>) -> ()
    return
  }
}
