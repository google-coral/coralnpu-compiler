module {
  func.func @tanh_rank1_bf16_8() {
    %cst = arith.constant dense<[0.000000e+00, 7.617180e-01, 9.648430e-01, 9.960930e-01, 1.000000e+00, 1.000000e+00, 1.000000e+00, 1.000000e+00]> : tensor<8xbf16>
    ...
    %1 = stablehlo.tanh %0 : tensor<8xbf16>
