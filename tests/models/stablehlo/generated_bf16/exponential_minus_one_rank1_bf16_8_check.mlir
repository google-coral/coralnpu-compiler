module {
  func.func @exponential_minus_one_rank1_bf16_8() {
    %cst = arith.constant dense<[0.000000e+00, 1.718750e+00, 6.375000e+00, 1.912500e+01, 5.350000e+01, 1.470000e+02, 4.020000e+02, 1.096000e+03]> : tensor<8xbf16>
    ...
    %1 = stablehlo.exponential_minus_one %0 : tensor<8xbf16>
