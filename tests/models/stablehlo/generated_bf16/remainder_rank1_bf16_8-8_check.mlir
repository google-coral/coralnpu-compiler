module {
  func.func @"remainder_rank1_bf16_8-8"() {
    %cst = arith.constant dense<[0x7FC0, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00]> : tensor<8xbf16>
    ...
    %2 = stablehlo.remainder %0, %1 : tensor<8xbf16>
