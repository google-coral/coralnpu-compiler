module {
  func.func @logistic_rank1_bf16_8() {
    %cst = arith.constant dense<[5.000000e-01, 7.304680e-01, 8.789060e-01, 9.531250e-01, 9.804680e-01, 9.921870e-01, 9.960930e-01, 1.000000e+00]> : tensor<8xbf16>
    ...
    %1 = stablehlo.logistic %0 : tensor<8xbf16>
