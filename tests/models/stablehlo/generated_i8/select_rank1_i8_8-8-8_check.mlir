module {
  func.func @"select_rank1_i8_8-8-8"() {
    ...
    %1 = util.optimization_barrier %cst : tensor<8xi8>
    %2 = util.optimization_barrier %cst : tensor<8xi8>
    %3 = stablehlo.select %0, %1, %2 : tensor<8xi1>, tensor<8xi8>
    %4 = util.optimization_barrier %cst : tensor<8xi8>
    "check.expect_eq"(%3, %4) : (tensor<8xi8>, tensor<8xi8>) -> ()
    return
  }
}
