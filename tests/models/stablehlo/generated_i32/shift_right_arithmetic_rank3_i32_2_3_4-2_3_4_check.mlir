module {
  func.func @"shift_right_arithmetic_rank3_i32_2_3_4-2_3_4"() {
    %cst = arith.constant dense<0> : tensor<2x3x4xi32>
    ...
    %2 = stablehlo.shift_right_arithmetic %0, %1 : tensor<2x3x4xi32>
