module {
  func.func @popcnt_rank4_i16_2_2_3_2() {
    %cst = arith.constant dense<[[[[0, 1], [1, 2], [1, 2]], [[2, 3], [1, 2], [2, 3]]], [[[2, 3], [3, 4], [1, 2]], [[2, 3], [2, 3], [3, 4]]]]> : tensor<2x2x3x2xi16>
    ...
    %1 = stablehlo.popcnt %0 : tensor<2x2x3x2xi16>
