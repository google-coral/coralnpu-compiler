module {
  func.func @"select_rank1_i16_8-8-8"() {
    ...
    %3 = stablehlo.select %0, %1, %2 : tensor<8xi1>, tensor<8xi16>
    %4 = util.optimization_barrier %cst : tensor<8xi16>
    "check.expect_eq"(%3, %4) : (tensor<8xi16>, tensor<8xi16>) -> ()
    return
  }
}
