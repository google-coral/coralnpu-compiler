module {
  func.func @popcnt_rank2_i16_4_8() {
    %cst = arith.constant dense<[[0, 1, 1, 2, 1, 2, 2, 3], [1, 2, 2, 3, 2, 3, 3, 4], [1, 2, 2, 3, 2, 3, 3, 4], [2, 3, 3, 4, 3, 4, 4, 5]]> : tensor<4x8xi16>
    ...
    %1 = stablehlo.popcnt %0 : tensor<4x8xi16>
