module {
  func.func @"shift_right_arithmetic_rank4_i16_2_2_3_2-2_2_3_2"() {
    %cst = arith.constant dense<0> : tensor<2x2x3x2xi16>
    ...
    %2 = stablehlo.shift_right_arithmetic %0, %1 : tensor<2x2x3x2xi16>
