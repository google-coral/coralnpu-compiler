module {
  func.func @"convolution_rank2_i16_4_8-8_4"() {
    ...
    %2 = stablehlo.convolution(%0, %1) dim_numbers = [b, f]x[i, o]->[b, f], window = {} {batch_group_count = 1 : i64, feature_group_count = 1 : i64} : (tensor<4x8xi16>, tensor<8x4xi16>) -> tensor<4x4xi16>
    %3 = util.optimization_barrier %cst : tensor<4x4xi16>
    "check.expect_eq"(%2, %3) : (tensor<4x4xi16>, tensor<4x4xi16>) -> ()
    return
  }
}
