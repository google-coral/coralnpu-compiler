module {
  func.func @"select_rank4_i16_2_2_3_2-2_2_3_2-2_2_3_2"() {
    ...
    %3 = stablehlo.select %0, %1, %2 : tensor<2x2x3x2xi1>, tensor<2x2x3x2xi16>
    %4 = util.optimization_barrier %cst : tensor<2x2x3x2xi16>
    "check.expect_eq"(%3, %4) : (tensor<2x2x3x2xi16>, tensor<2x2x3x2xi16>) -> ()
    return
  }
}
