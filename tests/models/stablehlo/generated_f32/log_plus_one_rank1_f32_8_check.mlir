module {
  func.func @log_plus_one_rank1_f32_8() {
    %cst = arith.constant dense<[0.000000e+00, 0.693147182, 1.09861231, 1.38629436, 1.60943794, 1.79175949, 1.94591022, 2.07944155]> : tensor<8xf32>
    ...
    %1 = stablehlo.log_plus_one %0 : tensor<8xf32>
