module {
  func.func @is_finite_rank3_f32_2_3_4() {
    ...
    %1 = stablehlo.is_finite %0 : (tensor<2x3x4xf32>) -> tensor<2x3x4xi1>
    %2 = util.optimization_barrier %cst : tensor<2x3x4xi1>
    "check.expect_eq"(%1, %2) : (tensor<2x3x4xi1>, tensor<2x3x4xi1>) -> ()
    return
  }
}
