module {
  func.func @rsqrt_rank1_f32_8() {
    %cst = arith.constant dense<[0x7F800000, 1.000000e+00, 0.707106769, 0.577350259, 5.000000e-01, 0.44721359, 0.408248276, 0.377964497]> : tensor<8xf32>
    ...
    %1 = stablehlo.rsqrt %0 : tensor<8xf32>
