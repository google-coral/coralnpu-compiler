module {
  func.func @"power_rank1_f32_8-8"() {
    %cst = arith.constant dense<[0xFFC00000, 1.000000e+00, 4.000000e+00, 27.0000019, 2.560000e+02, 3125.00049, 46656.0078, 823543.188]> : tensor<8xf32>
    ...
    %2 = stablehlo.power %0, %1 : tensor<8xf32>
