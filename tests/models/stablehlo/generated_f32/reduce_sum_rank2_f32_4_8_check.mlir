module {
  func.func @reduce_sum_rank2_f32_4_8() {
    ...
    %1 = stablehlo.reduce(%0 init: %cst_0) applies stablehlo.add across dimensions = [1] : (tensor<4x8xf32>, tensor<f32>) -> tensor<4xf32>
    %2 = util.optimization_barrier %cst : tensor<4xf32>
    "check.expect_almost_eq"(%1, %2) {rtol = 9.99999997E-7 : f32} : (tensor<4xf32>, tensor<4xf32>) -> ()
    return
  }
}
