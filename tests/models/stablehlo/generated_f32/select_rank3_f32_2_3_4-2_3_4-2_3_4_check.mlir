module {
  func.func @"select_rank3_f32_2_3_4-2_3_4-2_3_4"() {
    ...
    %1 = util.optimization_barrier %cst : tensor<2x3x4xf32>
    %2 = util.optimization_barrier %cst : tensor<2x3x4xf32>
    %3 = stablehlo.select %0, %1, %2 : tensor<2x3x4xi1>, tensor<2x3x4xf32>
    %4 = util.optimization_barrier %cst : tensor<2x3x4xf32>
    "check.expect_almost_eq"(%3, %4) {rtol = 9.99999997E-7 : f32} : (tensor<2x3x4xf32>, tensor<2x3x4xf32>) -> ()
    return
  }
}
