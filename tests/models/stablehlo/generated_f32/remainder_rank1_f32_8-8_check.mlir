module {
  func.func @"remainder_rank1_f32_8-8"() {
    %cst = arith.constant dense<[0xFFC00000, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00]> : tensor<8xf32>
    ...
    %2 = stablehlo.remainder %0, %1 : tensor<8xf32>
