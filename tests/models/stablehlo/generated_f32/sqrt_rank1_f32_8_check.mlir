module {
  func.func @sqrt_rank1_f32_8() {
    %cst = arith.constant dense<[0.000000e+00, 1.000000e+00, 1.41421354, 1.73205078, 2.000000e+00, 2.23606801, 2.44948983, 2.64575124]> : tensor<8xf32>
    ...
    %1 = stablehlo.sqrt %0 : tensor<8xf32>
