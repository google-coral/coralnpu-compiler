module {
  func.func @logistic_rank1_f32_8() {
    %cst = arith.constant dense<[5.000000e-01, 0.731058597, 8.807970e-01, 0.952574133, 0.982013761, 0.993307173, 0.99752742, 9.990890e-01]> : tensor<8xf32>
    ...
    %1 = stablehlo.logistic %0 : tensor<8xf32>
