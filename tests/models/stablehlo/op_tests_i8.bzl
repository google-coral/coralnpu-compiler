...
def stablehlo_op_tests_i8(name = "stablehlo_op_i8_tests"):
    ...
    op_tests_i8(name = "convolution_rank2_i8", instances = ["(4,8)(8,4)", "(120,256)(256,300)", "(300,100)(100,450)"], test = "convolution_rank2_i8.mlir")
    ...
    op_tests_i8(name = "matmul_rank2_i8", instances = ["(4,8)(8,4)", "(120,256)(256,300)", "(300,100)(100,450)"], test = "matmul_rank2_i8.mlir")
