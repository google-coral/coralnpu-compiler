...
def stablehlo_op_tests_i8(name = "stablehlo_op_i8_tests", check_mlir_files = None, generation_targets = None, target_dir = "generated_i8"):
    ...
    op_tests_i8(name = "compare_eq_rank1_i8", instances = ["(8)(8)", "(256)(256)", "(450)(450)"], test = "compare_eq_rank1_i8.mlir", tags = ["manual"])
    op_tests_i8(name = "compare_eq_rank2_i8", instances = ["(4,8)(4,8)", "(120,256)(120,256)", "(300,450)(300,450)"], test = "compare_eq_rank2_i8.mlir", tags = ["manual"])
    op_tests_i8(name = "compare_eq_rank3_i8", instances = ["(2,3,4)(2,3,4)", "(10,20,30)(10,20,30)", "(5,100,2)(5,100,2)"], test = "compare_eq_rank3_i8.mlir", tags = ["manual"])
    op_tests_i8(name = "compare_eq_rank4_i8", instances = ["(2,2,3,2)(2,2,3,2)", "(2,3,4,50)(2,3,4,50)", "(1,1,5,400)(1,1,5,400)"], test = "compare_eq_rank4_i8.mlir", tags = ["manual"])
    op_tests_i8(name = "concatenate_rank1_i8", instances = ["(8)(16)", "(256)(100)", "(450)(50)"], test = "concatenate_rank1_i8.mlir")
    op_tests_i8(name = "concatenate_rank2_i8", instances = ["(4,8)(4,16)", "(120,256)(120,100)", "(300,450)(300,50)"], test = "concatenate_rank2_i8.mlir", tags = ["manual"])
    op_tests_i8(name = "concatenate_rank3_i8", instances = ["(2,3,4)(2,3,8)", "(10,20,30)(10,20,10)", "(5,100,2)(5,100,5)"], test = "concatenate_rank3_i8.mlir", tags = ["manual"])
    op_tests_i8(name = "concatenate_rank4_i8", instances = ["(2,2,3,2)(2,2,3,4)", "(2,3,4,50)(2,3,4,10)", "(1,1,5,400)(1,1,5,100)"], test = "concatenate_rank4_i8.mlir", tags = ["manual"])
    ...
    op_tests_i8(name = "slice_rank2_i8", instances = ["(4,8)", "(120,256)", "(300,450)"], test = "slice_rank2_i8.mlir", tags = ["manual"])
    op_tests_i8(name = "slice_rank3_i8", instances = ["(2,3,4)", "(10,20,30)", "(5,100,4)"], test = "slice_rank3_i8.mlir", tags = ["manual"])
    op_tests_i8(name = "slice_rank4_i8", instances = ["(2,2,3,4)", "(2,3,4,50)", "(2,2,5,400)"], test = "slice_rank4_i8.mlir", tags = ["manual"])
    ...
    op_tests_i8(name = "count_leading_zeros_rank1_i8", instances = ["(8)", "(256)", "(450)"], test = "count_leading_zeros_rank1_i8.mlir")
    op_tests_i8(name = "count_leading_zeros_rank2_i8", instances = ["(4,8)", "(120,256)", "(300,450)"], test = "count_leading_zeros_rank2_i8.mlir")
    op_tests_i8(name = "count_leading_zeros_rank3_i8", instances = ["(2,3,4)", "(10,20,30)", "(5,100,2)"], test = "count_leading_zeros_rank3_i8.mlir")
    op_tests_i8(name = "count_leading_zeros_rank4_i8", instances = ["(2,2,3,2)", "(2,3,4,50)", "(1,1,5,400)"], test = "count_leading_zeros_rank4_i8.mlir")
    ...
    op_tests_i8(name = "power_rank2_i8", instances = ["(4,8)(4,8)", "(120,256)(120,256)", ("(300,450)(300,450)", ["manual"])], test = "power_rank2_i8.mlir")
