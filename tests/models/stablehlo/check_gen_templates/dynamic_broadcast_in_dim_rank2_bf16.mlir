func.func @main(%arg0: tensor<?xbf16>) -> tensor<?x?xbf16> {
  %dim0_0d_i32 = "stablehlo.get_dimension_size"(%arg0) {dimension = 0 : i64} : (tensor<?xbf16>) -> tensor<i32>
  ...
  } : (tensor<?xbf16>, tensor<2xi64>) -> tensor<?x?xbf16>
