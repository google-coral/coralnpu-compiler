func.func @main(%arg0: tensor<?x?x?xi16>) -> tensor<?x?x?x?xi16> {
  %dim0_0d_i16 = "stablehlo.get_dimension_size"(%arg0) {dimension = 0 : i64} : (tensor<?x?x?xi16>) -> tensor<i32>
  ...
  %dim1_0d_i16 = "stablehlo.get_dimension_size"(%arg0) {dimension = 1 : i64} : (tensor<?x?x?xi16>) -> tensor<i32>
  %dim1_0d_i64 = stablehlo.convert %dim1_0d_i16 : (tensor<i32>) -> tensor<i64>
  %dim1_1d = stablehlo.reshape %dim1_0d_i64 : (tensor<i64>) -> tensor<1xi64>
  %dim2_0d_i16 = "stablehlo.get_dimension_size"(%arg0) {dimension = 2 : i64} : (tensor<?x?x?xi16>) -> tensor<i32>
  %dim2_0d_i64 = stablehlo.convert %dim2_0d_i16 : (tensor<i32>) -> tensor<i64>
  ...
  } : (tensor<?x?x?xi16>, tensor<4xi64>) -> tensor<?x?x?x?xi16>
