func.func @main(%arg0: tensor<?x?x?xbf16>) -> tensor<?x?x?x?xbf16> {
  %dim0_0d_i32 = "stablehlo.get_dimension_size"(%arg0) {dimension = 0 : i64} : (tensor<?x?x?xbf16>) -> tensor<i32>
  ...
  %dim1_0d_i32 = "stablehlo.get_dimension_size"(%arg0) {dimension = 1 : i64} : (tensor<?x?x?xbf16>) -> tensor<i32>
  ...
  %dim2_0d_i32 = "stablehlo.get_dimension_size"(%arg0) {dimension = 2 : i64} : (tensor<?x?x?xbf16>) -> tensor<i32>
  ...
  } : (tensor<?x?x?xbf16>, tensor<4xi64>) -> tensor<?x?x?x?xbf16>
