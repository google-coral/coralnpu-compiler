func.func @main(%arg0: tensor<?x?xi32>) -> tensor<?x?x?xi32> {
  %dim0_0d_i32 = "stablehlo.get_dimension_size"(%arg0) {dimension = 0 : i64} : (tensor<?x?xi32>) -> tensor<i32>
  ...
  %dim1_0d_i32 = "stablehlo.get_dimension_size"(%arg0) {dimension = 1 : i64} : (tensor<?x?xi32>) -> tensor<i32>
