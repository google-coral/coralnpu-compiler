func.func @main(%arg0: tensor<?xi32>) -> tensor<?x?xi32> {
  %dim0_0d_i32 = "stablehlo.get_dimension_size"(%arg0) {dimension = 0 : i64} : (tensor<?xi32>) -> tensor<i32>
  ...
  } : (tensor<?xi32>, tensor<2xi64>) -> tensor<?x?xi32>
