func.func @main(%arg0: tensor<?xi8>) -> tensor<?x?xi8> {
  %dim0_0d_i8 = "stablehlo.get_dimension_size"(%arg0) {dimension = 0 : i64} : (tensor<?xi8>) -> tensor<i32>
  ...
  } : (tensor<?xi8>, tensor<2xi64>) -> tensor<?x?xi8>
