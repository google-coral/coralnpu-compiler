...
def stablehlo_op_tests_f32(name = "stablehlo_op_f32_tests", check_mlir_files = None, generation_targets = None, target_dir = "generated_f32"):
    ...
    op_tests_f32(name = "compare_eq_rank1_f32", instances = ["(8)(8)", "(256)(256)", "(450)(450)"], test = "compare_eq_rank1_f32.mlir", tags = ["manual"])
    op_tests_f32(name = "compare_eq_rank2_f32", instances = ["(4,8)(4,8)", "(120,256)(120,256)", "(300,450)(300,450)"], test = "compare_eq_rank2_f32.mlir", tags = ["manual"])
    op_tests_f32(name = "compare_eq_rank3_f32", instances = ["(2,3,4)(2,3,4)", "(10,20,30)(10,20,30)", "(5,100,2)(5,100,2)"], test = "compare_eq_rank3_f32.mlir", tags = ["manual"])
    op_tests_f32(name = "compare_eq_rank4_f32", instances = ["(2,2,3,2)(2,2,3,2)", "(2,3,4,50)(2,3,4,50)", "(1,1,5,400)(1,1,5,400)"], test = "compare_eq_rank4_f32.mlir", tags = ["manual"])
    op_tests_f32(name = "concatenate_rank1_f32", instances = ["(8)(16)", "(256)(100)", "(450)(50)"], test = "concatenate_rank1_f32.mlir")
    op_tests_f32(name = "concatenate_rank2_f32", instances = ["(4,8)(4,16)", "(120,256)(120,100)", "(300,450)(300,50)"], test = "concatenate_rank2_f32.mlir", tags = ["manual"])
    op_tests_f32(name = "concatenate_rank3_f32", instances = ["(2,3,4)(2,3,8)", "(10,20,30)(10,20,10)", "(5,100,2)(5,100,5)"], test = "concatenate_rank3_f32.mlir", tags = ["manual"])
    op_tests_f32(name = "concatenate_rank4_f32", instances = ["(2,2,3,2)(2,2,3,4)", "(2,3,4,50)(2,3,4,10)", "(1,1,5,400)(1,1,5,100)"], test = "concatenate_rank4_f32.mlir", tags = ["manual"])
    ...
    op_tests_f32(name = "slice_rank2_f32", instances = ["(4,8)", "(120,256)", "(300,450)"], test = "slice_rank2_f32.mlir", tags = ["manual"])
    op_tests_f32(name = "slice_rank3_f32", instances = ["(2,3,4)", "(10,20,30)", "(5,100,4)"], test = "slice_rank3_f32.mlir", tags = ["manual"])
    op_tests_f32(name = "slice_rank4_f32", instances = ["(2,2,3,4)", "(2,3,4,50)", "(2,2,5,400)"], test = "slice_rank4_f32.mlir", tags = ["manual"])
    ...
    op_tests_f32(name = "pad_rank2_f32", instances = ["(4,8)", "(120,256)", "(300,450)"], test = "pad_rank2_f32.mlir", tags = ["manual"])
    ...
    op_tests_f32(name = "case_rank1_f32", instances = ["(1)(8)", "(1)(256)"], test = "case_rank1_f32.mlir", tags = ["manual"])
    ...
    op_tests_f32(name = "scatter_rank1_f32", instances = [("(10)(3)(3)", ["manual"]), "(300)(256)(256)"], test = "scatter_rank1_f32.mlir")
    ...
    op_tests_f32(name = "remainder_rank1_f32", instances = ["(8)(8)", ("(256)(256)", ["manual"]), ("(450)(450)", ["manual"])], test = "remainder_rank1_f32.mlir")
    op_tests_f32(name = "remainder_rank2_f32", instances = ["(4,8)(4,8)", ("(120,256)(120,256)", ["manual"]), ("(300,450)(300,450)", ["manual"])], test = "remainder_rank2_f32.mlir")
    op_tests_f32(name = "remainder_rank3_f32", instances = ["(2,3,4)(2,3,4)", ("(10,20,30)(10,20,30)", ["manual"]), ("(5,100,2)(5,100,2)", ["manual"])], test = "remainder_rank3_f32.mlir")
    op_tests_f32(name = "remainder_rank4_f32", instances = ["(2,2,3,2)(2,2,3,2)", ("(2,3,4,50)(2,3,4,50)", ["manual"]), ("(1,1,5,400)(1,1,5,400)", ["manual"])], test = "remainder_rank4_f32.mlir")
    op_tests_f32(name = "is_finite_rank1_f32", instances = ["(8)", "(256)", "(450)"], test = "is_finite_rank1_f32.mlir", tags = ["manual"])
    op_tests_f32(name = "is_finite_rank2_f32", instances = ["(4,8)", "(120,256)", "(300,450)"], test = "is_finite_rank2_f32.mlir", tags = ["manual"])
    op_tests_f32(name = "is_finite_rank3_f32", instances = ["(2,3,4)", "(10,20,30)", "(5,100,2)"], test = "is_finite_rank3_f32.mlir", tags = ["manual"])
    op_tests_f32(name = "is_finite_rank4_f32", instances = ["(2,2,3,2)", "(2,3,4,50)", "(1,1,5,400)"], test = "is_finite_rank4_f32.mlir", tags = ["manual"])
