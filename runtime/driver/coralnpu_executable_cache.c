...
static const iree_hal_executable_cache_vtable_t
    iree_hal_coralnpu_executable_cache_vtable;

static iree_hal_coralnpu_executable_cache_t *
iree_hal_coralnpu_executable_cache_cast(
    iree_hal_executable_cache_t *base_value) {
  IREE_HAL_ASSERT_TYPE(base_value, &iree_hal_coralnpu_executable_cache_vtable);
  return (iree_hal_coralnpu_executable_cache_t *)base_value;
}
...
static void iree_hal_coralnpu_executable_cache_destroy(
...
static iree_status_t iree_hal_coralnpu_executable_cache_infer_format(
    iree_hal_executable_cache_t *base_executable_cache,
...
static const iree_hal_executable_cache_vtable_t
    iree_hal_coralnpu_executable_cache_vtable = {
        .destroy = iree_hal_coralnpu_executable_cache_destroy,
        .infer_format = iree_hal_coralnpu_executable_cache_infer_format,
        .can_prepare_format =
            iree_hal_coralnpu_executable_cache_can_prepare_format,
        .prepare_executable =
            iree_hal_coralnpu_executable_cache_prepare_executable,
};
