...
#define IREE_HAL_CORALNPU_DEVICE_ID_DEFAULT 0
...
static iree_status_t iree_hal_coralnpu_driver_query_available_devices(
  ...
  static const iree_hal_device_info_t device_infos[1] = {
      {
          .device_id = IREE_HAL_CORALNPU_DEVICE_ID_DEFAULT,
...
static iree_status_t iree_hal_coralnpu_driver_create_device_by_path(
  ...
  return iree_hal_coralnpu_driver_create_device_by_id(
      base_driver, IREE_HAL_CORALNPU_DEVICE_ID_DEFAULT, param_count, params,
